...
export default function HomeDashboard() {
  ...
  return (
    <div style={{
      ...
      <div style={{ // New centered container for app content
        ...
        <div style={{
          ...
          {/* ── 4 ACTION CARDS ────────────────────────────────────────────── */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[2], textAlign: 'left', minWidth: 0 }}>
            <span style={{ fontSize: '13.5px', fontWeight: typography.weight.bold, color: colors.text }}>What would you like to do today?</span>
            <div style={{ display: 'flex', gap: '14px', overflowX: 'auto', paddingBottom: spacing[2], scrollSnapType: 'x mandatory' }} className="no-scrollbar">
